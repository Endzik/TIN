...
<body>
    ...
    <div class="container">
        ...
        <hr>
        <form:form class="form-horizontal" method="POST" action="/categories/add" modelAttribute="category">
            <div class="form-group">
                <div class="col-sm-2"></div>
                <form:label class="control-label col-sm-2" path="name">Name:</form:label>
                <div class="col-sm-6">
                    <form:input class="form-control" placeholder="Category name" path="name"/>
                </div>
                <div class="col-sm-2"></div>
            </div>
            <div class="form-group">
